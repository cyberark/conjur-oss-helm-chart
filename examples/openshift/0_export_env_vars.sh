...
export IMAGE_REPOSITORY="${IMAGE_REPOSITORY:-registry.tld/cyberark/conjur}"
export IMAGE_TAG="${IMAGE_TAG:-latest}"
export NGINX_REPOSITORY="${NGINX_REPOSITORY:-registry.tld/cyberark/conjur-nginx}"
export NGINX_TAG="${NGINX_TAG:-latest}"
export POSTGRES_REPOSITORY="${POSTGRES_REPOSITORY:-registry.redhat.io/rhscl/postgresql-12-rhel7}"
